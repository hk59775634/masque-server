...
unexpected = sorted(healthy_instances - expected_instances)
if missing:
    print("[multi-node-ha] instance mismatch markdown follows")
    print("### HA Instance Matching")
    print("")
    print("| Type | Instances |")
    print("|---|---|")
    print(f"| expected_missing_in_healthy | {', '.join(missing)} |")
